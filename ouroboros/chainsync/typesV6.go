...
type TxV6 struct {
	...
	Mint                     []DoubleNestedMap     `json:"mint,omitempty"                     dynamodbav:"mint,omitempty"`
...
type ValueV6 struct {
	Ada LovelaceV6 `json:"ada,omitempty"  dynamodbav:"ada,omitempty"`
}

type LovelaceV6 struct {
	Lovelace num.Int `json:"lovelace,omitempty"  dynamodbav:"lovelace,omitempty"`
	Extras   []DoubleNestedMap
}

type DoubleNestedMap map[string]map[string]num.Int
